...
namespace EPlayers_AspNetCore.Controllers
{
    public class NoticiaController : Controller
    {
        ...
        public IActionResult Cadastrar(IFormCollection _formulario)
        {
            ...
            var _folderPicture = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/imgs/Noticia"); //Pegando o diretório atual da aplicação e combinar com a foto informada
